...
part of 'product_model_cart.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ProductResponseAdapter extends TypeAdapter<ProductResponseCart> {
  @override
  final int typeId = 0;

  @override
  ProductResponseCart read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ProductResponseCart(
      list: (fields[0] as List).cast<ProductModel>(),
  ...
  @override
  void write(BinaryWriter writer, ProductResponseCart obj) {
    writer
      ..writeByte(4)
      ..writeByte(0)
      ..write(obj.list)
